...
return [
    ...
    'timestamp' => 1689086960,
    'checksum' => '85f6f950ccfe88c2590d5345ab7ae27a',
    'files' => [
    ...
    'data' => [
        ...
        'styles' => [
            ...
            'navigation' => [
                'background' => '#f09f27',
                'text-color' => 'rgba(252, 252, 252, 0.97)'
            ],
            'offcanvas' => [
                'background' => '#4bb5b1',
                'text-color' => '#eceeef',
        ...
        'page' => [
            ...
            'assets' => [
                'favicon' => 'gantry-media://LOGO_KR.jpg'
            ]
        ],
        'index' => [
            'name' => '12',
            'timestamp' => 1689086955,
            'version' => 7,
            'preset' => [
            ...
            'particles' => [
                ...
                'custom' => [
                    'custom-9595' => 'Custom HTML',
                    'custom-2082' => 'Custom HTML',
                    'custom-8024' => 'Custom HTML',
                    'custom-3989' => 'Custom HTML',
                    'custom-3164' => 'Custom HTML'
                ],
                'menu' => [
                    'menu-6409' => 'Menu'
                ],
