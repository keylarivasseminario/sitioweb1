...
return [
    ...
    'timestamp' => 1688082736,
    'checksum' => 'c502d0b37dfd0e235efc34eaddea86d9',
    'files' => [
        'templates/g5_helium/custom/config/13' => [
            ...
            'styles' => [
                'file' => 'templates/g5_helium/custom/config/13/styles.yaml',
                'modified' => 1688082736
            ]
        ],
    ...
    'data' => [
        ...
        'index' => [
            ...
            'particles' => [
                'messages' => [
                    'system-messages-6603' => 'System Messages'
                ],
                'logo' => [
                    'logo-5108' => 'Logo / Image',
                    'logo-9040' => 'Logo / Image'
                ],
                'menu' => [
                    'menu-2878' => 'Menu'
                ],
                ...
                'copyright' => [
                    'copyright-1052' => 'Copyright'
                ],
                'horizontalmenu' => [
                    'horizontalmenu-3877' => 'Horizontal Menu'
                ],
                'totop' => [
                    'totop-3473' => 'To Top'
                ],
                'mobile-menu' => [
                    'mobile-menu-1455' => 'Mobile-menu'
                ]
            ],
            'inherit' => [
                'default' => [
                    'navigation' => 'navigation',
                    'system-messages-6603' => 'system-messages-7972',
                    'logo-5108' => 'logo-9608',
                    'menu-2878' => 'menu-6409',
                    'social-9866' => 'social-3171',
                    'footer' => 'footer',
                    'logo-9040' => 'logo-9571',
                    'copyright-1052' => 'copyright-1736',
                    'horizontalmenu-3877' => 'horizontalmenu-9034',
                    'totop-3473' => 'totop-8670',
                    'offcanvas' => 'offcanvas',
                    'mobile-menu-1455' => 'mobile-menu-5697'
                ]
            ]
        ],
        'layout' => [
